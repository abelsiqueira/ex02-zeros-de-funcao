...
[
  ...
  EquacaoNL(x -> ln(x^3), log(3), "Log"),
  EquacaoNL(x -> sin(exp(x)) * log(x), 4.0, "Função tipo seno e log"),
  EquacaoNL(x -> exp(x) - 1, log(3), "Exp"),
  EquacaoNL(x -> x * log(x) - 5, log(3), "Log"),
  EquacaoNL(x -> (exp(x^2) - exp(x))/(5x), 1.0, "Exp"),
